      ...
      <div class="bg-cream-dark border border-tan-border rounded-2xl p-6 flex flex-col gap-4">
        ...
        <div class="flex items-center gap-3 flex-wrap">
          <div class="flex items-center gap-[4px] cursor-pointer" @click="params.enable = !params.enable">
            ...
            <span class="text-[13px] text-brown shrink-0">启用目录格式化</span>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <input type="text" v-model="params.title_text"
              class="w-[140px] shrink-0 bg-white border border-tan-border rounded-lg px-[12px] py-[8px] text-[13px] text-brown outline-none focus:border-cinnabar transition-colors" />
          </div>
        </div>
        <template v-if="params.enable">
          ...
          <div class="grid grid-cols-3 gap-3">
            <div class="flex items-center gap-2">
              ...
              <DropdownSelect v-model="params.title_cn_font" :options="cnFonts" width-class="w-full" />
            </div>
            <div class="flex items-center gap-2">
              <span class="text-[13px] text-brown whitespace-nowrap shrink-0">英文字体</span>
              <DropdownSelect v-model="params.title_en_font" :options="enFonts" width-class="w-full" />
            </div>
            <div class="flex items-center gap-2">
              <span class="text-[13px] text-brown whitespace-nowrap shrink-0">字号</span>
              <DropdownSelect v-model="params.title_size_cn" :options="sizeCN" width-class="w-full" />
            </div>
          </div>
        </template>
      </div>
            ...
            <div :key="activeLevel" class="flex flex-col gap-4">
              ...
              <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                  <div class="flex items-center gap-2">
                    <span class="text-[13px] text-brown whitespace-nowrap shrink-0">中文字体</span>
                    <DropdownSelect v-model="params.level_styles[activeLevel].cn_font" :options="cnFonts" width-class="w-full" />
                  </div>
                  <div class="flex items-center gap-2">
                    <span class="text-[13px] text-brown whitespace-nowrap shrink-0">英文字体</span>
                    <DropdownSelect v-model="params.level_styles[activeLevel].en_font" :options="enFonts" width-class="w-full" />
                  </div>
                  <div class="flex items-center gap-2">
                    <span class="text-[13px] text-brown whitespace-nowrap shrink-0">字号</span>
                    <DropdownSelect v-model="params.level_styles[activeLevel].size_cn" :options="sizeCN" width-class="w-full" />
                  </div>
                  <div class="flex items-center gap-2">
              ...
              <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                  <div class="flex items-center gap-2">
                    ...
                    <DropdownSelect v-model="params.level_styles[activeLevel].line_spacing_mode" :options="lineSpacingModes" width-class="w-full" />
                  </div>
                  <div class="flex items-center gap-2">
                    ...
                    <input type="number" step="0.1" v-model.number="params.level_styles[activeLevel].line_spacing_value"
                      class="w-[60px] shrink-0 bg-white border border-tan-border rounded-lg px-[12px] py-[8px] text-[13px] text-brown outline-none focus:border-cinnabar transition-colors" />
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <DropdownSelect v-model="params.level_styles[activeLevel].space_before_unit" :options="spacingUnits" width-class="w-full" />
                  </div>
                  <div class="flex items-center gap-2">
                    ...
                    <input type="number" step="0.1" v-model.number="params.level_styles[activeLevel].space_after_value"
                      class="w-[55px] shrink-0 bg-white border border-tan-border rounded-lg px-[12px] py-[8px] text-[13px] text-brown outline-none focus:border-cinnabar transition-colors" />
                    <DropdownSelect v-model="params.level_styles[activeLevel].space_after_unit" :options="spacingUnits" width-class="w-full" />
                  </div>
                  <div class="flex items-center gap-2">
              ...
              <div>
                ...
                <div class="flex items-center gap-2">
                  <span class="text-[13px] text-brown shrink-0">前导符样式</span>
                  <DropdownSelect v-model="params.level_styles[activeLevel].tab_leader" :options="tabLeaders" width-class="w-full" />
                </div>
              </div>
            </div>
          </Transition>
