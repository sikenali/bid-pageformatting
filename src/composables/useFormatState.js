...
const formatParams = reactive({
  ...
  patterns: {
    rules: [
      { enabled: true, scheme: 'ZH_NUM', wrapper: 'DUNHAO', multi_depth: '1', custom_example: '' },
      { enabled: true, scheme: 'ZH_NUM', wrapper: 'DOUBLE_PAREN', multi_depth: '1', custom_example: '' },
      { enabled: true, scheme: 'ARABIC', wrapper: 'DOT', multi_depth: '1', custom_example: '' },
      { enabled: true, scheme: 'ARABIC', wrapper: 'SINGLE_PAREN', multi_depth: '1', custom_example: '' },
    ],
  },
  ...
  toc: {
    ...
    title_size_cn: '三号',
    level_styles: [
      { cn_font: '黑体', en_font: 'Times New Roman', size_cn: '四号', bold: true, italic: false, color_rgb: [0, 0, 0], line_spacing_mode: 'EXACT', line_spacing_value: 28, space_before_value: 0, space_before_unit: '磅', space_after_value: 0, space_after_unit: '磅', left_indent_value: 0, tab_leader: 'DOT' },
      { cn_font: '仿宋', en_font: 'Times New Roman', size_cn: '小四', bold: false, italic: false, color_rgb: [0, 0, 0], line_spacing_mode: 'EXACT', line_spacing_value: 28, space_before_value: 0, space_before_unit: '磅', space_after_value: 0, space_after_unit: '磅', left_indent_value: 1, tab_leader: 'DOT' },
      { cn_font: '仿宋', en_font: 'Times New Roman', size_cn: '五号', bold: false, italic: false, color_rgb: [0, 0, 0], line_spacing_mode: 'EXACT', line_spacing_value: 28, space_before_value: 0, space_before_unit: '磅', space_after_value: 0, space_after_unit: '磅', left_indent_value: 2, tab_leader: 'DOT' },
      { cn_font: '仿宋', en_font: 'Times New Roman', size_cn: '五号', bold: false, italic: false, color_rgb: [0, 0, 0], line_spacing_mode: 'EXACT', line_spacing_value: 28, space_before_value: 0, space_before_unit: '磅', space_after_value: 0, space_after_unit: '磅', left_indent_value: 3, tab_leader: 'DOT' },
    ],
  },
